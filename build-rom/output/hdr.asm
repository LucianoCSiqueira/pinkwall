...
.ROMBANKS 32                     ; 1024 Mbits - Tell WLA we want to use 32 ROM Banks

.SNESHEADER
  ID "SNES"                     ; 1-4 letter string, just leave it as "SNES"

  NAME "Pink Wall - The Game "  ; Program Title - can't be over 21 bytes,
  ...
  ROMSIZE $0A                   ; $08=2 Megabits, $09=4 Megabits,$0A=8 Megabits,$0B=16 Megabits,$0C=32 Megabits
